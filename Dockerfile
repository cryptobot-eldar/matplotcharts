...
COPY chart_creator.py chart_creator2.py chart_creator3.py chart_creator4.py chart_creator5.py config.py requirements.txt view.py start.sh /usr/local/bin/
